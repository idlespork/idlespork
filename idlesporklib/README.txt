...
"jobs -o<jobid>" prints the output of a job. If you want to get the output of
jobs without printing it, use 'Jobs[jobid].getoutput()'.
...
If you lose this variable use can run:
    jobs -gJobs
and this will assign the variable Jobs again.
